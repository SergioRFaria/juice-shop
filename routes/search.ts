...
export function searchProducts() {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    //The current Juice Shop source uses user-controlled criteria directly inside the SQL string, which is exactly the SQL Injection pattern Checkmarx detected.
